...
var _compiler = require('./rules/compiler');
...
const spa = (0, _generalWebpack2.default)({
  ...
  rules: [...(0, _compiler2.default)({
    babel: {
      presets: [],
      plugins: [['inferno', { 'imports': true }]],
      envPreset: _prepareBuildTools.babelEnvSpa
    },
    exclude: [/node_modules/, /mobx.js/]
  }), (0, _css2.internalCSS)(), (0, _css2.externalCSS)(), (0, _files.file)()],
...
const server = (0, _generalWebpack2.default)({
  ...
  ...(0, _compiler2.default)({
    babel: {
      presets: [],
      plugins: ['inferno'],
      envPreset: _prepareBuildTools.babelEnvServer
    },
    exclude: [/node_modules/, /mobx.js/]
  }), (0, _css2.internalCSS)(), (0, _css2.externalCSS)(), (0, _files.file)()],
  plugins: [
