...
Rearguard - это интрумент сборки и разработки сайтов, одностраничных приложений, мобильных и десктопных приложений (на базе проекта Cordova). Инструмент поддерживает библиотека ориентированную парадигму разработки. Также поддерживается способ разработки известный как монорепозиторий. Монолитный способ разработки не исключён и является частным случаем.
