# Rearguard [![Build Status](https://travis-ci.org/Techintouch/rearguard.svg?branch=master)](https://travis-ci.org/Techintouch/rearguard)
...
- Легкость обновления конфигурации сборки на нескольких проектах, просто поднять версию пакета.
...
для rearguard поля то вы получите сообщение о том что сущесьвую поля которые не используются. Если забыть указать
