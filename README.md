...
- Проверка конфигурации на избыточные свойства и на недостающие или некорректные, имеется в виду build.config.json 
содержит полный список полей доступных для конфигурации ни больше и ни меньше. Если указать каки то неизвестные 
